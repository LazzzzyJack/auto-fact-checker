    ...
    try {
      ...
      textAnalysis().then((res) => {
        ...
        filteredFacts.forEach(element => {
          formattedResponse = formattedResponse.replace(element, "<span style=\"color:red\">" + element + "</span>")
        });
        formattedResponse = formattedResponse.replace(" Identify the facts and seperate them with newlines.", "")
